...
_![图片](../_media/874963-20180817190641218-447291698.png ':size=100%')
...
_![图片](../_media/874963-20180818144746732-183931471.png ':size=100%')
...
_![图片](../_media/874963-20180808170412526-1782553229.png ':size=100%')

Beats可以直接（或者通过Logstash）将数据发送到Elasticsearch，在那里你可以进一步处理和增强数据，然后在Kibana中将其可视化。

### 第1步：安装Filebeat

_![图片](../_media/874963-20180808171725468-641427623.png ':size=100%')
...
_![图片](../_media/874963-20180808182426196-188738357.png ':size=100%')
